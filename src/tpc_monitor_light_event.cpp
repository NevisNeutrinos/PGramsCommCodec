...
std::vector<int32_t> TpcMonitorLightEvent::serialize() const {
...
std::vector<int32_t>::const_iterator TpcMonitorLightEvent::deserialize(std::vector<int32_t>::const_iterator begin,
