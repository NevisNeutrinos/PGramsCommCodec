...
// Copy of pGRAMSBalloon/include/CommunicationCodes.hh for standalone GramsReadout
// builds. If BALLOON_BASE_DIR is set, CMake uses the balloon header instead and
// this file is not on the include path.
